...
export function canAccess(role:AppRole|undefined,page:string){return (page==='users'&&role==='PLANNER')||access(role,page,current)||(page==='spare-parts'&&perform(role,'stock-transactions','POST',undefined,current));}
