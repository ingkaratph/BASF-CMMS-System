...
BEGIN
    ...
    BEGIN
        ...
        BEGIN
            ...
            ORDER BY AssetID OPTION (RECOMPILE, MAXDOP 1, LOOP JOIN, MAX_GRANT_PERCENT = 1);
            RETURN;
        END;
        ...
        BEGIN
            ...
            ORDER BY W.WorkOrderID DESC OPTION (RECOMPILE, MAXDOP 1, LOOP JOIN, MAX_GRANT_PERCENT = 1);
            RETURN;
        END;
        ...
        BEGIN
            ...
            ORDER BY T.TransactionDate DESC,T.StockTransactionID DESC OPTION (RECOMPILE, MAXDOP 1, LOOP JOIN, MAX_GRANT_PERCENT = 1);
            RETURN;
        END;
    ...
    BEGIN
        ...
        BEGIN
            ...
            (
                ...
                RequestDepartment,Title,Description,DueDate,RequestorName,SourceSystem,DataQualityStatus,CreatedBy
            )
            VALUES
            (
                @WONo,@WOAssetID,@WorkTypeID,@PriorityID,@WOStatusID,
                JSON_VALUE(@BodyJson,'$.requestDepartment'),@Title,@Description,@DueDate,@RequestorName,N'API',N'OK',SUSER_SNAME()
            );
