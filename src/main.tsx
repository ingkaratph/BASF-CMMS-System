...
function ModulePage({
  ...
  if(resource==='spare-parts'&&inventoryTab==='planning'&&(role==='PLANNER'||role==='ADMINISTRATOR'))return <>{inventoryTabs}<Replenishment/></>;
